  ...
  return (
    <div className="container mx-auto p-4 bg-gray-10 min-h-screen">
      ...
      <div className="flex justify-center items-center mb-8 pt-4">
        ...
        <h2 className="text-4xl text-primary font-bold">Study Video</h2>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="col-span-full md:col-span-2">
            <label className="block text-sm font-bold mb-2 flex items-center">
              <FaFile className="text-blue-500 mr-2" /> Video URL
            </label>
            <input 
              type="text" 
              value={videoUrl}
        ...
        <div className="mt-8">
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                {["Edit", "Course", "Subject", "Lesson", "Video URL"].map((text, idx) => (
              ...
              {currentRecords.length > 0 ? (
                currentRecords.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td className="px-6 py-2">{item.videoUrl}</td>
                  </tr>
                ))
              ) : (
