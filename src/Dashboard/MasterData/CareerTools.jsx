...
const dummyTools = [
    { id: '9814207', tool: 'Spray booth' },
    { id: '9812706', tool: 'Steel bridge' },
    { id: '8014071', tool: 'Costumes or accessories' },
    { id: '8014061', tool: 'Balance or gross motor equipment' },
    { id: '8014051', tool: 'Game accessories' },
    { id: '8014041', tool: 'Dice' },
    { id: '8014031', tool: 'Puzzles' },
    { id: '8014021', tool: 'Video games' },
    { id: '8014011', tool: 'Playing cards' },
    { id: '8014001', tool: 'Board games' },
];
...
const CareerTools = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!tool.trim()) newErrors.tool = true;
        ...
        const newTool = {
            id: `80140${tools.length + 1}`.padStart(7, '0'), // Continue from the last ID pattern (e.g., 8014001, 8014002, etc.)
            tool: tool.trim(),
        };
    ...
    const handleDelete = (id) => {
        if (window.confirm(`Are you sure you want to delete tool ID: ${id}?`)) {
    ...
    const currentRecords = filteredTools.slice(indexOfFirstRecord, indexOfLastRecord);
    const totalPages = Math.ceil(filteredTools.length / recordsPerPage);
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto bg-white shadow-md rounded-lg border border-blue-300">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 flex items-center">
                <FaChalkboardTeacher className="mr-2 text-blue-500" /> Career-Tools
            </h2>
            ...
            <form onSubmit={handleSubmit} className="mb-8 space-y-4 p-4 rounded-lg ">
                <div className="relative">
                    ...
                    {errors.tool && <span className="text-red-500 text-sm">* Tool is required</span>}
                </div>
                <button
                    type="submit"
                    ...
                    <tbody>
                        {currentRecords.map((t) => (
                            <tr key={t.id} className="hover:bg-gray-50 transition">
                                ...
                                <td className="border border-gray-200 px-4 py-2 text-black-800">{t.tool}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
            ...
            <div className="flex justify-between items-center mt-6 text-black-600">
                <span>Showing {indexOfFirstRecord + 1} to {Math.min(indexOfLastRecord, filteredTools.length)} of {filteredTools.length} entries</span>
