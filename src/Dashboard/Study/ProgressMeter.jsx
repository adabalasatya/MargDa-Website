              ...
              <div className="absolute top-1/2 left-[55%] transform -translate-x-1/2 -translate-y-1/2 w-[72%] h-7 rounded-full overflow-hidden border border-gray-300 flex">
                ...
                <div
                  className={`h-full transition-all duration-500 ${
                    activeStep >= 1 ? "bg-red-500" : "bg-transparent"
                  }`}
                  style={{ width: "30%" }}
                ></div>
                ...
                <div
                  className={`h-full transition-all duration-500 ${
                    activeStep >= 2 ? "bg-yellow-400" : "bg-transparent"
                  }`}
                  style={{ width: "30%" }}
                ></div>
                {/* Green - Appears third */}
                <div
                  className={`h-full transition-all duration-500 ${
                    activeStep >= 3 ? "bg-green-500" : "bg-transparent"
                  }`}
                  style={{ width: "40%" }}
                ></div>
              </div>
