...
const dummyData = [
  {
    ...
    practical: "Test",
    info: "<html><head><title></title></head><body>test1</body></html>",
    pdf: "1art 1.pdf",
    video: "1shipping.mp4",
    marks: "100",
  },
  ...
  return (
    <div className="container mx-auto p-4 bg-gray-10 min-h-screen">
      <div className="flex justify-center items-center mb-8 pt-4">
        ...
        <h2 className="text-4xl text-primary font-bold">Study Practical</h2>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-bold mb-2 flex items-center">
              <FaBookReader className="text-blue-500 mr-2" /> Practical
            </label>
            <input 
              type="text" 
              value={practical} 
          ...
          <div>
            <label className="block text-sm font-bold mb-2 flex items-center">
              <FaFile className="text-blue-500 mr-2" /> Practical Pdf
            </label>
            <input 
              type="file" 
          ...
          <div>
            <label className="block text-sm font-bold mb-2 flex items-center">
              <FaFile className="text-blue-500 mr-2" /> Practical Video
            </label>
            <input 
              type="file" 
          ...
          <div className="col-span-full">
            <label className="block text-sm font-bold mb-2 flex items-center">
              <FaBookReader className="text-blue-500 mr-2" /> Practical Info
            </label>
            <Editor
          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="bg-white">
                ...
                <th className="px-4 py-2 border-b text-left">
                  <FaBookReader className="text-blue-500 inline mr-2" /> Practical
                </th>
                <th className="px-4 py-2 border-b text-left">
            ...
            <tbody>
              {currentRecords.map((item) => (
                <tr key={item.id} className="odd:bg-gray-50 even:bg-white">
                  ...
                  <td className="px-4 py-2 border-b">{item.practical}</td>
