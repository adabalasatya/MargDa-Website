...
const PlaceOrderPage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen font-sans">
      ...
      {/* Main Content */}
      <div className="container mx-auto pt-24 pb-8 px-6">
        {orderPlaced && (
        ...
        {showNetBankingModal && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
            <div className="bg-white p-8 rounded-xl shadow-lg w-96">
              <h2 className="text-2xl font-semibold mb-6">Net Banking Details</h2>
        ...
        <h1 className="text-3xl font-bold mb-8 text-gray-800">Place Your Order</h1>
        <button
          onClick={() => navigate(-1)}
        ...
        <div className="bg-gray-50 p-8 rounded-xl shadow-lg border border-gray-200 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              {/* Amount Payable */}
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl border border-gray-200 shadow-md">
              ...
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl border border-gray-200 shadow-md">
                <div className="flex justify-between items-center mb-4">
                  <p className="text-gray-800 font-medium">Account Balance:</p>
                  <p className="text-blue-700 font-semibold">₹500.00</p>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <button className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-300">
                    Pay Now
                  </button>
                </div>
              </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl border border-gray-200 shadow-md">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <p className="text-blue-700 font-semibold">₹200.00</p>
                </div>
                <div className="flex items-center gap-3">
                  <input
                    type="number"
              ...
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl border border-gray-200 shadow-md">
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <p className="text-blue-600 font-semibold">₹200.00</p>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <button className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:from-green-700 hover:to-green-800 focus:ring-2 focus:ring-green-300">
                    Pay Online
                  </button>
                </div>
              </div>
