          ...
          {timelineData.map((event, index) => (
            <div key={index} className="flex-shrink-0 mr-6">
              ...
              <div className="relative">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-full flex items-center justify-center shadow-lg" 
                     style={{ backgroundColor: 
                       event.type === 'Call SIM' || event.type === 'Call API' ? 'blue' :
                       event.type === 'Email Gmail' ? 'red' :
                       event.type === 'WhatsApp' ? 'green' :
                       event.type === 'SMS' ? 'yellow' : 'gray' 
                     }}>
